...
const mongoUrl = `mongodb+srv://${DB_USER}:${DB_PASSWD}@${DB_HOST}.evwtm.mongodb.net/${DB_NAME}?retryWrites=true&w=majority`;
let connection;

//mongodb+srv://<username>:<password>@cluster0.evwtm.mongodb.net/myFirstDatabase?retryWrites=true&w=majority
